...
last_name='sachade', 
email_address='bansi.sachade@tatvasoft.com'
WHERE customer_id = 1;

-- only row show the table with first name
...
FROM
	customer
WHERE first_name IN ('1','David','James');
